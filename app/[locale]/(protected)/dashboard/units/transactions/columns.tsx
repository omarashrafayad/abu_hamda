...
import useDeleteUnit from "@/services/units/deleteUnit";

export const baseColumns = ({ refresh, t }: { refresh: () => void; t: (key: string) => string }): ColumnDef<UnitType>[] => [
    {
        accessorKey: "id",
        header: "ID",
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const { deleteUnit, loading } = useDeleteUnit();
                    ...
                    action: (
                        <div className="flex justify-end mx-auto items-center my-auto gap-2">
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    try {
                                        const isSuccess = await deleteUnit(id as string | number);
