...
import getUnits from "@/services/units/getAllUnits";
...
const UnitsTable = () => {
    ...
    const { units: data, loading, getAllUnits } = getUnits();
    const t = useTranslations("units");
    const columns = baseColumns({ refresh: getAllUnits, t });
        ...
        <div className="w-full">
            <div className="flex flex-col sm:flex-row justify-between items-center py-4 px-6 border-b border-solid border-default-200 gap-4">
                <div className="w-full sm:w-auto flex-1">
                    <SearchInput data={data ?? []} setFilteredData={setFilteredUnits} filterKey={"name"} placeholder={t("searchPlaceholder")} />
                </div>
                <div className="flex items-center gap-4">
                    <Link href="/dashboard/add-unit">
