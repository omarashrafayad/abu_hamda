...
const ZonesTable = () => {
    ...
    const { zones: data, loading, getAllZones } = useGetZones();
    const t = useTranslations("zones");
    const columns = baseColumns({ refresh: getAllZones, t });
    ...
    return (
        <div className="w-full">
            <div className="flex flex-wrap justify-end items-center py-4 px-6 border-b border-solid border-default-200 gap-4">
                <SearchInput data={data ?? []} setFilteredData={setFilteredZones} filterKey={"name"} placeholder="Search zones..." />
                <div className="#flex-none">
                    <div className="flex items-center gap-4 flex-wrap">
                        <Link href="/dashboard/add-zone">
