...
const CountriesTable = () => {
    ...
    const { countries: data, loading, getAllCountries } = useGetCountries();
    const t = useTranslations("countries");
    const columns = baseColumns({ refresh: getAllCountries, t });
    ...
    return (
        <div className="w-full">
            <div className="flex flex-wrap justify-end items-center py-4 px-6 border-b border-solid border-default-200 gap-4">
                <SearchInput data={data ?? []} setFilteredData={setFilteredCountries} filterKey={"name"} placeholder="Search countries..." />
                <div className="#flex-none">
                    <div className="flex items-center gap-4 flex-wrap">
                        <Link href="/dashboard/add-country">
